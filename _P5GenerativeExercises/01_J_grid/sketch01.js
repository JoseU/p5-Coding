...
function draw() {
  ...
  count = mouseX / 20 + 5;
  var mouseYmod = mouseY / height - 0.5;
  ...
  for (var gridY = 0; gridY <= tileCountY; gridY++) {
    ...
    for (var gridX = 0; gridX <= tileCountX; gridX++) {
      ...
      for (var i = 0; i <= count; i++) {
        ...
        strokeWeight(mouseYmod * 2.66332);
        stroke(colours[i % 3]);
        rotate(TWO_PI / mouseYmod);
        rect(0, mouseYmod * tileHeight, (i / count) * tileWidth, mouseYmod * tileHeight);
